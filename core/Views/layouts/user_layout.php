...
<head>
    ...
    <meta name="pusher-key" content="<?= $_ENV['PUSHER_APP_KEY'] ?? '' ?>">
    <meta name="pusher-cluster" content="<?= $_ENV['PUSHER_APP_CLUSTER'] ?? 'mt1' ?>">
    <meta name="hotel-id" content="<?= (int)($_SESSION['hotel_id'] ?? $_SESSION['active_hotel_id'] ?? 0) ?>">
    
    <!-- PWA Manifest -->
    <link rel="manifest" href="<?= base_url('/manifest.json') ?>">
    <meta name="theme-color" content="var(--header)">
...
<body class="flex flex-col h-screen overflow-hidden bg-[var(--light)] selection:bg-[var(--theme)] selection:text-white font-sans">
    ...
    <?php if (!empty($_SESSION['impersonator_id'])): ?>
        <div class="bg-[var(--theme)] text-[var(--header)] px-6 py-2 flex flex-col sm:flex-row justify-between items-center text-xs font-bold uppercase tracking-widest z-50 relative shadow-md shrink-0">
            ...
            <form action="<?= base_url('/user/stop-impersonating') ?>" method="POST" class="m-0">
                <?= csrf_field() ?>">
    ...
    <div class="flex flex-1 overflow-hidden">
        ...
        <aside id="sidebar" class="fixed inset-y-0 left-0 w-64 glass-dark text-[var(--white)] flex flex-col shadow-2xl z-30 transform -translate-x-full md:relative md:translate-x-0 transition-transform duration-300 ease-in-out flex-shrink-0">
            ...
            <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
                ...
                <a href="<?= base_url('/user/dashboard') ?>" class="flex items-center px-4 py-3 rounded-lg font-bold border-l-4 transition-all duration-300 <?= $uri === '/user/dashboard' ? 'bg-[var(--theme2)] text-[var(--white)] border-[var(--theme)] shadow-lg translate-x-1' : 'text-[var(--white)]/60 hover:bg-[var(--white)]/5 hover:text-[var(--white)] border-transparent hover:border-[var(--white)]/20' ?>">
                ...
                <a href="<?= base_url('/user/bookings') ?>" class="flex items-center px-4 py-3 rounded-lg font-bold border-l-4 transition-all duration-300 <?= $uri === '/user/bookings' ? 'bg-[var(--theme2)] text-[var(--white)] border-[var(--theme)] shadow-lg translate-x-1' : 'text-[var(--white)]/60 hover:bg-[var(--white)]/5 hover:text-[var(--white)] border-transparent hover:border-[var(--white)]/20' ?>">
                ...
                <a href="<?= base_url('/user/calendar') ?>" class="flex items-center px-4 py-3 rounded-lg font-bold border-l-4 transition-all duration-300 <?= $uri === '/user/calendar' ? 'bg-[var(--theme2)] text-[var(--white)] border-[var(--theme)] shadow-lg translate-x-1' : 'text-[var(--white)]/60 hover:bg-[var(--white)]/5 hover:text-[var(--white)] border-transparent hover:border-[var(--white)]/20' ?>">
                ...
                <a href="<?= base_url('/user/guests') ?>" class="flex items-center px-4 py-3 rounded-lg font-bold border-l-4 transition-all duration-300 <?= str_starts_with($uri, '/user/guests') || str_starts_with($uri, '/user/guest-profile') ? 'bg-[var(--theme2)] text-[var(--white)] border-[var(--theme)] shadow-lg translate-x-1' : 'text-[var(--white)]/60 hover:bg-[var(--white)]/5 hover:text-[var(--white)] border-transparent hover:border-[var(--white)]/20' ?>">
                ...
                <a href="<?= base_url('/user/housekeeping') ?>" class="flex items-center px-4 py-3 rounded-lg font-bold border-l-4 transition-all duration-300 <?= $uri === '/user/housekeeping' ? 'bg-[var(--theme2)] text-[var(--white)] border-[var(--theme)] shadow-lg translate-x-1' : 'text-[var(--white)]/60 hover:bg-[var(--white)]/5 hover:text-[var(--white)] border-transparent hover:border-[var(--white)]/20' ?>">
                ...
                <a href="<?= base_url('/user/rates') ?>" class="flex items-center px-4 py-3 rounded-lg font-bold border-l-4 transition-all duration-300 <?= strpos($uri, '/user/rates') === 0 ? 'bg-[var(--theme2)] text-[var(--white)] border-[var(--theme)] shadow-lg translate-x-1' : 'text-[var(--white)]/60 hover:bg-[var(--white)]/5 hover:text-[var(--white)] border-transparent hover:border-[var(--white)]/20' ?>">
                    <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                    Rate Manager
                </a>
                <a href="<?= base_url('/user/channel-manager') ?>" class="flex items-center px-4 py-3 rounded-lg font-bold border-l-4 transition-all duration-300 <?= str_starts_with($uri, '/user/channel-manager') ? 'bg-[var(--theme2)] text-[var(--white)] border-[var(--theme)] shadow-lg translate-x-1' : 'text-[var(--white)]/60 hover:bg-[var(--white)]/5 hover:text-[var(--white)] border-transparent hover:border-[var(--white)]/20' ?>">
                ...
                <a href="<?= base_url('/user/reports') ?>" class="flex items-center px-4 py-3 rounded-lg font-bold border-l-4 transition-all duration-300 <?= str_starts_with($uri, '/user/reports') ? 'bg-[var(--theme2)] text-[var(--white)] border-[var(--theme)] shadow-lg translate-x-1' : 'text-[var(--white)]/60 hover:bg-[var(--white)]/5 hover:text-[var(--white)] border-transparent hover:border-[var(--white)]/20' ?>">
                    <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path></svg>
                    P&L Reports
                </a>
                <a href="<?= base_url('/user/expenses') ?>" class="flex items-center px-4 py-3 rounded-lg font-bold border-l-4 transition-all duration-300 <?= str_starts_with($uri, '/user/expenses') ? 'bg-[var(--theme2)] text-[var(--white)] border-[var(--theme)] shadow-lg translate-x-1' : 'text-[var(--white)]/60 hover:bg-[var(--white)]/5 hover:text-[var(--white)] border-transparent hover:border-[var(--white)]/20' ?>">
                    <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                    Expenses
                </a>
                ...
                <a href="<?= base_url('/user/audit-logs') ?>" class="flex items-center px-4 py-3 rounded-lg font-bold border-l-4 transition-all duration-300 <?= $uri === '/user/audit-logs' ? 'bg-[var(--theme2)] text-[var(--white)] border-[var(--theme)] shadow-lg translate-x-1' : 'text-[var(--white)]/60 hover:bg-[var(--white)]/5 hover:text-[var(--white)] border-transparent hover:border-[var(--white)]/20' ?>">
                ...
                <a href="<?= base_url('/user/staff') ?>" class="flex items-center px-4 py-3 rounded-lg font-bold border-l-4 transition-all duration-300 <?= $uri === '/user/staff' ? 'bg-[var(--theme2)] text-[var(--white)] border-[var(--theme)] shadow-lg translate-x-1' : 'text-[var(--white)]/60 hover:bg-[var(--white)]/5 hover:text-[var(--white)] border-transparent hover:border-[var(--white)]/20' ?>">
                    <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>
                    Staff Members
                </a>
        ...
        <div class="flex-1 flex flex-col min-w-0 overflow-hidden">
            <header class="glass border-b border-[var(--border)] h-16 flex items-center justify-between px-6 shadow-sm z-10 shrink-0">
                <div class="flex items-center">
                    ...
                    <?php if (isset($_SESSION['user_properties']) && count($_SESSION['user_properties']) > 1): ?>
                        <form action="<?= base_url('/user/switch-property') ?>" method="POST" class="m-0 flex items-center">
                            <?= csrf_field() ?>">
            ...
            <?php if ($isAccountExpired): ?>
                <div class="bg-[var(--theme)] text-[var(--header)] px-4 py-3 text-center text-[13px] font-bold flex flex-col md:flex-row justify-center items-center shadow-md tracking-wide z-20 shrink-0 gap-4">
                    ...
                    <div class="flex items-center">
                        <a href="<?= base_url('/user/settings') ?>" class="bg-[var(--header)] text-[var(--theme)] hover:bg-[var(--theme2)] hover:text-[var(--white)] px-4 py-1.5 rounded shadow text-xs uppercase tracking-widest transition-colors">
                            Renew Plan
                        </a>
                    </div>
                </div>
