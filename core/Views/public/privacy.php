...
<main class="bg-[var(--light)] min-h-screen py-24 px-5">
    <div class="max-w-4xl mx-auto bg-[var(--white)] border border-[var(--border)] rounded-2xl shadow-xl overflow-hidden">
        ...
        <div class="p-10 md:p-16 space-y-8 text-[var(--text)] text-sm leading-relaxed font-medium">
            ...
            <section>
                <h2 class="text-xl font-extrabold text-[var(--header)] mb-3 uppercase tracking-wide">Sharing</h2>
            ...
            <section>
                <h2 class="text-xl font-extrabold text-[var(--header)] mb-3 uppercase tracking-wide">Security Precautions</h2>
            ...
            <section>
                <h2 class="text-xl font-extrabold text-[var(--header)] mb-3 uppercase tracking-wide">Data Deletion and Retention</h2>
            ...
            <section>
                <h2 class="text-xl font-extrabold text-[var(--header)] mb-3 uppercase tracking-wide">Your Rights & Consent</h2>
            ...
            <div class="mt-12 bg-[var(--light)] p-6 rounded border border-[var(--border)]">
                <h3 class="font-bold text-[var(--header)] mb-3 uppercase tracking-wide">Contact Us</h3>
                <div class="space-y-1 text-sm">
                    <p><strong>Company:</strong> Adhyan Creatives</p>
                    <p><strong>Address:</strong> Gandhinagar, Kumta, Uttara Kannada, Karnataka</p>
                    <p><strong>Phone:</strong> +91 7975365475 (Mon - Fri, 9:00 - 18:00)</p>
                    <p><strong>Email:</strong> kgsanjay.kallabbe@gmail.com</p>
                </div>
            </div>
        </div>
    </div>
